...
interface
//Procédure que affiche l'interface du hall
procedure afficherInterface(); 

implementation
  
uses
  SysUtils, Classes, GestionEcran, unitHallLogic, unitTaverneIHM,journalihm;
...
begin
  ...
  deplacerCurseurXY(9, 35); write('6/ Menu Principal pour créer une nouvelle partie ou quitter');
