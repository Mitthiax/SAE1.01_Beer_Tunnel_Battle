...
implementation
uses
  SysUtils, Classes, GestionPerso, unitCoffreLogic;
...
begin
  ...
  begin
    ...
    degatrecureal:=degatrecu-(degatrecu*(getDefenceJoueur()/100));//calcul les degats reçu avec le bonus de protection (svp faites en sortes que la deffense depasse pas 100 sinon il risque de give des points de vie)
