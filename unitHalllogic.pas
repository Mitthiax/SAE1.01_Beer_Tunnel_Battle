...
implementation
  uses
  SysUtils, Classes, unitHallIhm, unitTaverneIHM, unitTaverne, unitMineLogic, unitCoffreLogic, unitMarchandIHM, unitForgeLogic, unitChambreIhm, unitMenuPrincipalLogic, unitInterfaceForgeIHM;
...
procedure AllerTaverne;
begin
  //Appel l'interface de la Taverne pour aller dans la taverne
