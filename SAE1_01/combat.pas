...
begin
  ...
  begin
    ...
    degatrecu:=degatrecu-(degatrecu*(deffense/100));//calcul les degats reçu avec le bonus de protection (svp faites en sortes que la deffense depasse pas 100 sinon il risque de give des points de vie)
    if degatrecu<0 then
    begin
      degatrecu:=0;
    end;
